...
public interface Context {
   ...
   * #setInitialized()}). Used to forbid multipart packet reassembly before authentication, so that
   * a rogue server cannot drive the client to {@link OutOfMemoryError} pre-auth.
   *
