...
public class BitParseTest extends BaseTest {
  ...
  //        .expectNextMatches(
  //            val -> {
  //              if (val.get().length != 2) return false;
  //              return val.get()[0] == (byte) 0;
  //            })
  //        .expectNextMatches(
  //            val -> {
  //              if (val.get().length != 2) return false;
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof R2dbcTransientResourceException
                    && throwable
                        .getMessage()
                        .equals("No decoder for type java.lang.Short and column type BIT"))
        .verify();
  }
  //
  //  @Test
  ...
  //                    && throwable
  //                        .getMessage()
  //                        .equals("No decoder for type java.lang.Integer and column type BIT"))
  //        .verify();
  //  }
  //
  //  @Test
  ...
  //                    && throwable
  //                        .getMessage()
  //                        .equals("No decoder for type java.lang.Long and column type BIT"))
  //        .verify();
  //  }
  //
  //  @Test
  ...
  //                    && throwable
  //                        .getMessage()
  //                        .equals("No decoder for type java.math.BigDecimal and column type BIT"))
  //        .verify();
  //  }
  //
  //  @Test
  ...
  //                    && throwable
  //                        .getMessage()
  //                        .equals("No decoder for type java.math.BigInteger and column type BIT"))
  //        .verify();
  //  }
}
