...
public class BitParameterTest extends BaseTest {
  ...
  //        stmt.toString()
  //            .contains(
  //                "parameters=[Parameter{codec=BooleanCodec{}, value=true},
  // Parameter{codec=BooleanCodec{}, value=true}, Parameter{codec=BooleanCodec{}, value=false}]"));
  ...
  //  //        .bind(1, Blob.from(Mono.just(ByteBuffer.wrap(new byte[] {(byte) 1, 0, (byte)
  // 127}))))
